...
var $c = {
  ...
  strokeOpacity: 1,
  strokeWidth: 1
}, Wt = typeof process < "u" && process.env !== void 0 && (process.env.REACT_APP_SC_ATTR || process.env.SC_ATTR) || "data-styled", Gs = "active", Xs = "data-styled-version", Zn = "6.1.17", Va = `/*!sc*/
`, bn = typeof window < "u" && "HTMLElement" in window, Ac = !!(typeof SC_DISABLE_SPEEDY == "boolean" ? SC_DISABLE_SPEEDY : typeof process < "u" && process.env !== void 0 && process.env.REACT_APP_SC_DISABLE_SPEEDY !== void 0 && process.env.REACT_APP_SC_DISABLE_SPEEDY !== "" ? process.env.REACT_APP_SC_DISABLE_SPEEDY !== "false" && process.env.REACT_APP_SC_DISABLE_SPEEDY : typeof process < "u" && process.env !== void 0 && process.env.SC_DISABLE_SPEEDY !== void 0 && process.env.SC_DISABLE_SPEEDY !== "" ? process.env.SC_DISABLE_SPEEDY !== "false" && process.env.SC_DISABLE_SPEEDY : process.env.NODE_ENV !== "production"), Fc = {}, yo = /invalid hook call/i, Wr = /* @__PURE__ */ new Set(), Js = function(r, n) {
...
B.div`
  ...
  height: 40vh;
`;
const Re = 50, pt = 24, yr = 16, It = 40, ir = It + yr + pt, Ct = 84, Ie = 56, Be = 196, st = 12, Ye = 50, cr = 24, Tr = 16, Ea = 40, Cl = cr + Tr + Ea, Oo = 1, To = 52, ze = {
...
`, J1 = ({ width: r, showThemeToggle: n, toggleTheme: t }) => {
  ...
  return /* @__PURE__ */ re(j1, { width: r, className: "topbar-wrapper", children: [
    ...
    /* @__PURE__ */ re(Q1, { className: "topbar-navigation", children: [
      ...
      /* @__PURE__ */ re(z1, { children: [
        /* @__PURE__ */ L(U1, { onClick: c, children: e.today }),
        /* @__PURE__ */ L(
          V1,
          {
            selected: /* @__PURE__ */ new Date(),
            onSelect: (x) => l(W(x)),
            customInput: /* @__PURE__ */ L(q1, { children: /* @__PURE__ */ L(Le, { iconName: "calendar", height: "15", fill: v.textPrimary }) })
          }
        )
      ] }),
